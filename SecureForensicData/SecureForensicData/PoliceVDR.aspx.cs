...
{
    public partial class PoliceVDR : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (tab.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < tab.Rows.Count; i++)
                    {
                        ...
                        string res = objBLL.ChkDRCaseTamper(objDTO);
                        string imgpath = "";
        ...
        void Recover_Click(object sender, EventArgs e)
        {
            ...
            string result = objBLL.DRCaseRecover(objDTO);
            if (result == "1")
            {
                LoadData();
        ...
        void View_Click(object sender, EventArgs e)
        {
            ...
            if (result.Split('&')[0] == "1")
            {
                ...
                Response.Redirect("DRPolice.aspx");
            }
        }
    }
}