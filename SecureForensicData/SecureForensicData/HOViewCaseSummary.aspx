<%@ Page Title="" Language="C#" MasterPageFile="~/HO.Master" AutoEventWireup="true" CodeBehind="HOViewCaseSummary.aspx.cs" Inherits="SecureForensicData.HOViewCaseSummary" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header">
            Crime Case Summary</h3>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
