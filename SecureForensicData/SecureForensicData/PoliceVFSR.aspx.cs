...
{
    public partial class PoliceVFSR : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            try
            {
                ...
                objDTO.TableName = Session["UserId"].ToString() + "_" + ddlCrime.SelectedItem.Value + "_" + keyvalue;
                ...
                if (tab.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < tab.Rows.Count; i++)
                    {
                        ...
                        string res = objBLL.ChkFSCaseTamper(objDTO);
                        string imgpath = "";
        ...
        void Recover_Click(object sender, EventArgs e)
        {
            ...
            string result = objBLL.FSCaseRecover(objDTO);
            if (result == "1")
            {
                LoadData();
