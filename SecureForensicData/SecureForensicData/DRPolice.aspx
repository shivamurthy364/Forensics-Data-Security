<%@ Page Title="" Language="C#" MasterPageFile="~/Police.Master" AutoEventWireup="true" CodeBehind="DRPolice.aspx.cs" Inherits="SecureForensicData.DRPolice" %>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="form-group">
                                     <label>
                                        ...
                                        <asp:TextBox ID="txtMedicalReport" runat="server" class="form-control" TextMode="MultiLine"></asp:TextBox>
