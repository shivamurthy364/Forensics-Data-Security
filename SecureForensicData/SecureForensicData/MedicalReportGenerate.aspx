<%@ Page Title="" Language="C#" MasterPageFile="~/Doctor.Master" AutoEventWireup="true" CodeBehind="MedicalReportGenerate.aspx.cs" Inherits="SecureForensicData.MedicalReportGenerate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header">
                    Medical Report Generate</h3>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
