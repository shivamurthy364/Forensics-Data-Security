<%@ Page Title="" Language="C#" MasterPageFile="~/ApplicationManager.Master" AutoEventWireup="true" CodeBehind="AddHigherOfficer.aspx.cs" Inherits="SecureForensicData.AddHigherOfficer" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header">
                    Higher Officer Information</h3>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    <label>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Select Role" InitialValue="--Select--" ForeColor="Red" ValidationGroup="A" ControlToValidate="ddlRole"></asp:RequiredFieldValidator>
                                </div>
