<%@ Page Title="" Language="C#" MasterPageFile="~/Forensic.Master" AutoEventWireup="true" CodeBehind="AddForensicData.aspx.cs" Inherits="SecureForensicData.AddForensicData" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header">
                    Forensic Data Log Information</h3>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
