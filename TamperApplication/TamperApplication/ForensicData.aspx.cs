...
{
    public partial class ForensicData : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            try
            {
                ...
                tab = obj.GetFSReport(ddlPoliceStation.SelectedItem.Value + "_" + ddlCrime.SelectedItem.Value + "_" + keyvalue);
        ...
        void Edit_Click(object sender, EventArgs e)
        {
            ...
            string res = obj.TamperData(SlNo, ddlPoliceStation.SelectedItem.Value + "_" + ddlCrime.SelectedItem.Value + "_" + keyvalue);
            if (res == "1")
            {
                Response.Redirect("ForensicData.aspx");
            }
        }
    }
}