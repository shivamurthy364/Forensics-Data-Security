<%@ Page Title="" Language="C#" MasterPageFile="~/Tamper.Master" AutoEventWireup="true" CodeBehind="DoctorReport.aspx.cs" Inherits="TamperApplication.DoctorReport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header">
                    Doctor Medical Report</h3>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
